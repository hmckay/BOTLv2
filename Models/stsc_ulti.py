...
def reformat_result(cluster_labels, n, names):
    zipped_data = zip(cluster_labels, names, range(n))
    # for i in range(5):
        # print(i)
    ...
    grouped_feature_name = [[j[2] for j in i[1]] for i in groupby(zipped_data, lambda x: x[0])]
    # print(grouped_feature_name)
    return grouped_feature_id,grouped_feature_name

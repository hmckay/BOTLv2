...
def nextModels(existingModels,transitionMatrix,modelOrder,DF,currentModID,target,DROP_FIELDS,startIDX,initTM,DEFAULT_PRED):
    ...
    if total == 0:
        ...
        if acc<ACC_THRESHOLD:
            ...
            m = createModel.createPipeline(df,target,DROP_FIELDS,DEFAULT_PRED)

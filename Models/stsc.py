#code adapted from: https://github.com/wOOL/STSC
import numpy as np
...
def calcAffinity(base,k,affinityMetric,distanceMatrix=None,affinityMatrix=None,names=None,newTarget=True,targetModelName=0):
    ...
    print("affinity matrix")
    print(affinityMatrix)
    return distanceMatrix,affinityMatrix,tc
...
def STSC(metaX,affinityMetric,targetModelName,k,distanceMatrix=None,affinityMatrix=None,newTarget=True):
    ...
    distanceMatrix,affinityMatrix,tc = calcAffinity(metaX,k,metric,distanceMatrix,affinityMatrix,
    ...
    return groupedName,distanceMatrix,affinityMatrix,tc
